...
private:
	...
	char **maze_;
        ...
        // Indica la ocupacion de cada columna
	char *tope_;

	// Ultimas acciones realizadas por los jugadores.
	int last_action1_, last_action2_;

	// Jugador al que le toca realizar el siguiente movimiento
	int jugador_activo_;

	// Cantidad de casillas que aun quedan libres.
	...
	// Cada cuanto se puede poner una bomba
	int n_veces;
